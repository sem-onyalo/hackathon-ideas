...
class ModelManager:
    ...
    models = [
        {
            'modelPath': 'core/models/mobilenet_ssd_v1_coco/frozen_inference_graph.pb',
            'configPath': 'core/models/mobilenet_ssd_v1_coco/ssd_mobilenet_v1_coco_2017_11_17.pbtxt',
            'classNames': { 
